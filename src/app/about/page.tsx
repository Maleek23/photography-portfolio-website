          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <Link href="/services">
                  <button className="bg-primary hover:bg-primary/90 text-white font-[600] px-8 py-4 rounded-lg uppercase text-[0.875rem] transition-all shadow-lg hover:shadow-primary/50 hover:scale-105">
                    Book a Session
                  </button>
                </Link>
                <Link href="/contact">
                  <button className="bg-superGray hover:bg-superGray/80 text-white font-[600] px-8 py-4 rounded-lg uppercase text-[0.875rem] transition-all hover:scale-105">
                    Get In Touch
                  </button>
                </Link>
              </div>
            ...
            {specialties.map((specialty, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 p-6 flex flex-col justify-end">
                  <p className={`text-white text-[1.75rem] font-[700] uppercase transition-all duration-300 ${
                    hoveredCard === index ? 'translate-y-0 opacity-100' : 'translate-y-2'
                  }`}>
                    {specialty.title}
                  </p>
                  <p className={`text-white/90 text-[0.938rem] mt-2 transition-all duration-500 ${
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/collections">
                <button className="bg-transparent border-2 border-primary text-primary hover:bg-primary hover:text-white font-[600] px-8 py-4 rounded-lg uppercase text-[0.875rem] transition-all hover:scale-105">
                  View Portfolio
                </button>
              </Link>
              <Link href="/services">
