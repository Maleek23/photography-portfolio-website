        ...
        <div className="bg-gradient-to-b from-primary/5 via-background to-background">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {projects.map((project) => (
              ...
              >
                {/* Cover Image */}
                <div className="aspect-[4/3] overflow-hidden bg-superGray relative">
                  <Image
                ...
                <div className="p-6 md:p-8">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-customGrayAlt text-[0.75rem] md:text-[0.875rem]">
                      {project.date}
                    </span>
                    <span className="text-customGrayAlt2 text-[0.75rem]">•</span>
                    <span className="text-customGrayAlt text-[0.75rem] md:text-[0.875rem]">
                      {project.client}
                    </span>
                  </div>
                  ...
                  <p className="text-customGrayAlt text-[0.875rem] md:text-[1rem] leading-relaxed mb-4">
                    {project.description}
                  </p>
          ...
          <div className="mt-8 md:mt-12 text-center glass glass-mobile-optimized rounded-3xl p-8 md:p-12 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/contact"
                className="glass glass-hover glass-lift backdrop-blur-xl text-white font-[600] py-4 px-8 rounded-xl uppercase text-[0.875rem] border border-white/20 hover:border-primary transition-all hover:scale-105"
              >
                Get In Touch
              </Link>
            </div>
