          ...
          <div className="px-4 md:px-[6rem] py-12 md:py-16">
            ...
            <ScrollReveal>
              <div className="mb-8 md:mb-12">
                <h1 className="text-white light:text-gray-900 text-2xl md:text-4xl font-medium mb-3">
                  {project.title}
                </h1>

                <p className="text-white/50 light:text-gray-500 text-base md:text-lg max-w-3xl">
                  {project.subtitle}
                </p>
              </div>
            </ScrollReveal>
