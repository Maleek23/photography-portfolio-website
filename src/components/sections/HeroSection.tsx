      ...
      <section className="flex justify-center items-center flex-col px-4 md:px-[6rem] py-[2rem] md:py-[2.5rem]">
        <div className="text-center max-w-5xl">
          <div className="flex items-center justify-center gap-3 mb-3">
            ...
            <p className="text-primary uppercase text-[0.875rem] md:text-[1rem] font-[600] tracking-widest">
              Stunning Creativity
            </p>
            <div className="h-[1px] w-12 bg-primary"></div>
          </div>
          <p className="uppercase font-[700] text-[2.75rem] md:text-[5.5rem] text-white leading-[0.95] tracking-tight">
            {PORTFOLIO_OWNER_FULLNAME}
          </p>
          <p className="text-customGrayAlt text-[0.875rem] md:text-[1rem] font-[400] mt-3 tracking-wide">
            Photographer • Videographer • Visual Artist
          </p>
        </div>
      </section>

      {/* Animated Category Marquee - Much Smaller */}
