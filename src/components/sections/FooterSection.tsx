      ...
      <div className="px-4 md:px-[6rem] py-6 md:py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 md:gap-12 mb-6">
          ...
          <div className="flex flex-wrap gap-x-8 gap-y-4 md:gap-12">
            ...
            {/* Collections */}
            <div>
              <p className="text-white text-[0.813rem] font-[600] uppercase tracking-wider mb-2">Portfolio</p>
              <div className="space-y-1.5">
                <p className="text-customGrayAlt text-[0.875rem]">Portraits</p>
                <p className="text-customGrayAlt text-[0.875rem]">Graduation</p>
                <p className="text-customGrayAlt text-[0.875rem]">Creative</p>
                <p className="text-customGrayAlt text-[0.875rem]">Events</p>
              </div>
            </div>

            {/* Contact */}
            <div>
              <p className="text-white text-[0.813rem] font-[600] uppercase tracking-wider mb-2">Connect</p>
              <p className="text-customGrayAlt text-[0.875rem] mb-2">Texas, USA</p>
